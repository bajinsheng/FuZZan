...
if [ $3 == 2 ]; then
  export MINMODE_ON="1"
  ../../../afl/afl-2.52b/afl-fuzz -t 1000 -i ../full-seeds/$1 -o ./fuzz/$1/$4 -m none -- ./$1/prelink-$1/$1 -n -e -r  @@
else
  export MINMODE_ON="0"
  ../../../afl/afl-2.52b-native/afl-fuzz -t 1000 -i ../full-seeds/$1 -o ./fuzz/$1/$4 -m none -- ./$1/$1 -n -e -r  @@
fi
...
if [ $3 == 2 ]; then
  export MINMODE_ON="1"
  ../../../afl/afl-2.52b/afl-fuzz -t 1000 -i ../full-seeds/$1 -o ./fuzz/$1/$4 -m none -- ./gif2png/prelink-$1/$1  @@
else
  export MINMODE_ON="0"
  ../../../afl/afl-2.52b-native/afl-fuzz -t 1000 -i ../full-seeds/$1 -o ./fuzz/$1/$4 -m none -- ./gif2png/$1  @@
fi
...
if [ $3 == 2 ]; then
  export MINMODE_ON="1"
  ../../../afl/afl-2.52b/afl-fuzz -t 1000 -i ../full-seeds/$1 -o ./fuzz/$1/$4 -m none -- ./libpng/prelink-$1/$1  @@
else
  export MINMODE_ON="0"
  ../../../afl/afl-2.52b-native/afl-fuzz -t 1000 -i ../full-seeds/$1 -o ./fuzz/$1/$4 -m none -- ./libpng/build/bin/$1  @@
fi
...
if [ $3 == 2 ]; then
  export MINMODE_ON="1"
  ../../../afl/afl-2.52b/afl-fuzz -t 5000 -i ../full-seeds/$1 -o ./fuzz/$1/$4 -m none -- ./ffmpeg/ffmpeg_AV_CODEC_ID_MPEG4_fuzzer @@
else
  export MINMODE_ON="0"
  ../../../afl/afl-2.52b-native/afl-fuzz -t 5000 -i ../full-seeds/$1 -o ./fuzz/$1/$4 -m none -- ./ffmpeg/ffmpeg_AV_CODEC_ID_MPEG4_fuzzer @@
fi
...
if [ $3 == 2 ]; then
  export MINMODE_ON="1"
  ../../../afl/afl-2.52b/afl-fuzz -t 1000 -i ../full-seeds/$1 -o ./fuzz/$1/$4 -m none -- ./$1/prelink-$1/$1 -m ./$1/magic/magic.mgc @@
else
  export MINMODE_ON="0"
  ../../../afl/afl-2.52b-native/afl-fuzz -t 1000 -i ../full-seeds/$1 -o ./fuzz/$1/$4 -m none -- ./$1/file -m ./$1/magic/magic.mgc @@
fi
elif [ $1 == "objdump" ]
then
if [ $3 == 2 ]; then
  export MINMODE_ON="1"
  ../../../afl/afl-2.52b/afl-fuzz -t 1000 -i ../full-seeds/$1 -o ./fuzz/$1/$4 -m none -- ./binutils/prelink-$1/$1 -a @@
else
  export MINMODE_ON="0"
  ../../../afl/afl-2.52b-native/afl-fuzz -t 1000 -i ../full-seeds/$1 -o ./fuzz/$1/$4 -m none -- ./binutils/$1 -a @@
fi
elif [ $1 == "c++filt" ]
then
if [ $3 == 2 ]; then
  export MINMODE_ON="1"
  ../../../afl/afl-2.52b/afl-fuzz -t 1000 -i ../full-seeds/$1 -o ./fuzz/$1/$4 -m none -- ./binutils/prelink-$1/$1 -n
else
  export MINMODE_ON="0"
  ../../../afl/afl-2.52b-native/afl-fuzz -t 1000 -i ../full-seeds/$1 -o ./fuzz/$1/$4 -m none -- ./binutils/$1 -n
fi
else
if [ $3 == 2 ]; then
  export MINMODE_ON="1"
  ../../../afl/afl-2.52b/afl-fuzz -t 1000 -i ../full-seeds/$1 -o ./fuzz/$1/$4 -m none -- ./binutils/prelink-$1/$1 @@
else
  export MINMODE_ON="0"
  ../../../afl/afl-2.52b-native/afl-fuzz -t 1000 -i ../full-seeds/$1 -o ./fuzz/$1/$4 -m none -- ./binutils/$1 @@
fi
fi
